              ...
              <div class="col-md-7">
                 <div class="row">
                    ...
                    <div class="gray-inp  px-4 py-3">
                        ...
                        <p class="description-text-gray"> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non cumque odio, sapiente fugiat voluptas voluptatibus fugit aliquid obcaecati explicabo dolorum eaque similique laborum architecto ipsa vero. Quasi cumque sint ducimus.</p>
                        <ul class="ps-0">
                        <li class="li_blue"> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non cumque odio, sapiente fugiat </li>
                        <li class="li_blue"> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non cumque odio, sapiente fugiat </li>
                        <li class="li_blue"> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non cumque odio, sapiente fugiat </li>
                        <li class="li_blue"> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non cumque odio, sapiente fugiat </li>
                        </ul>
                    ...
                    <div class="gray-inp mt-3 tickets px-4 py-3">
                        ...
                        <table class="table text-center">
                            ...
                            <tr>
                                ...
                                <td>20$</td>
                                <td>
                                    <a class="book-now" data-bs-toggle="modal" data-bs-target="#tickets_normal"> Book Now </a>
                                </td>
                            </tr>
                            <tr>
                                <td>VIP</td>
                                ...
                                <td>40$</td>
                                <td>
                                    <a class="book-now" data-bs-toggle="modal" data-bs-target="#tickets_vip"> Book Now </a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
