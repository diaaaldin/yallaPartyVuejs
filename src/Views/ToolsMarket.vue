    ...
    methods: {
        ...
        initFunc() {
            ...
            this.GetTools(this.dataSearch).then(Response => {
                ...
                console.log("getToolsData : ", this.getToolsData);
                                ...
                                <div class="d-flex justify-content-between align-items-center py-2">
                                    <div class="justify-content-start  d-flex">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0)" class="list_link ms-2"> {{ getUserData.name }} </a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="d-flex justify-content-between align-items-center py-2">
                                    <div class="justify-content-start  d-flex">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0)" class="list_link ms-2"> {{ getCityName(getUserData.cityId) }} </a>
                                        </div>
                                    </div>
                                </div>
                            </li>
