...
export default {
    ...
    async created() {
        ...
        if (this.getUserData.stateId) {
            await this.fetchSearchCities(this.getUserData.stateId);
        }
    },
    watch: {
    ...
    methods: {
        ...
        initFunc() {
            ...
            this.GetUserInfo(id);
            this.GetTools(this.dataSearch).then(Response => {
            ...
            <div class="container">
                ...
                <div class="d-flex justify-content-between mt-5 search_input">
                    <div class="input-group">
                        <input @input="SearchChangeFunc()" v-model="dataSearch.toolName" type="text"
                                ...
                                <div class="d-flex justify-content-between align-items-center py-2">
                                    <div class="justify-content-start  d-flex">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0)" class="list_link ms-2"> {{ getUserData.name }}
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center py-2">
                                    <div class="justify-content-start  d-flex">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0)" class="list_link ms-2"> {{
                                                getCityName(getUserData.cityId) }} </a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="container white_card px-4 pb-4 pt-4 pb-0 mt-3 mt-lg-0 right-side">
                        <div class="Product">
                            ...
                            <div class="row first_sec">
                                <toolCard v-for="item in toolsData" :tool='item'></toolCard>
                            </div>
                        </div>
