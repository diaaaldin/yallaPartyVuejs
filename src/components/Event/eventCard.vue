            ...
            <div class="mt-4">
                <div class="d-flex justify-content-between a1">
                    <div class=" d-flex align-items-center titlep-text">
                        ...
                        <span class="ms-2"> 17/12/2024 </span>
                    </div>
                    <div class="d-flex align-items-center titlep-text">
                        ...
                        <span class="ms-2">1814 Broadway NY, New York </span>
                    </div>
                    <div class="d-flex align-items-center titlep-text">
                        ...
                        <span class="ms-2">ahmedStore </span>
                    </div>

                    <div class="justify-content-end go">
                        <a href="" @click="goToEventFunc()">
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-between ">
                    <div class=" d-flex align-items-center">
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iure cumque,
                            aperiam corrupti inventore vitae nihil ullam porro aperiam corrupti....
                        </p>
                    </div>
                </div>
            </div>
