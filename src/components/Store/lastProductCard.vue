...
<template>
    <div class="col-12 col-lg-3 col-md-6 mt-4" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700">
        <a href="details-product.html" style="color:black;">
            <div class="card custom_card">
                <img src="/img/pr2.jpg" class="card-img-top index-img-card latest" alt="...">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-baseline mb-2">
                        ...
                        <a href="javascript:void(0)" class="justify-content-end">
                            <svg width="21" height="17" stroke="#7C90A6" class="heart_svg" onclick="toggleHeartFill()"
                                ...
                                <path
                                    ...
                                    fill="white" stroke="#999999" stroke-width="1.4" />
                            </svg>
                        </a>
                    </div>
                    <div class="d-flex align-items-center">
                        <p class="text-store">Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Doloremque, ullam? Optio tempora natus molestiae eveniet quo,
                            voluptatibus eligendi repellendus pariatur dolorum explicabo non vero
                            nobis excepturi tempore ducimus maxime modi.</p>
                    </div>
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-end flex-column">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <a href="campany.html"><span class="text-store"> Campany
                                        Name</span></a>
                            </div>
                        </div>
                    </div>
