            ...
            <div class="row">
              <div class="col-12 col-lg-2 px-0">
                <a href="details-product.html">
                  <div class="image">
                    <img class="img-fluid" src="/img/pr7.jpg" alt="">
                  </div>
                </a>
              ...
              <div class="col-12 col-lg-10 ">
                <div class="d-flex justify-content-between align-items-center mt-2 mt-lg-0">
                  ...
                  <div class="d-flex justify-content-end text-end">
                    ...
                    <svg @click="toggleHeartFill" width="21" height="17" :stroke="isFilled ? 'red' : '#999999'" class="heart_svg"
                ...
                <div class="d-flex justify-content-between align-items-center mt-2 ">
                  <div class="d-flex justify-content-start align-items-center ">
                    <span class="description-text-gray ms-1">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Doloremque, ullam? Optio tempora natus molestiae eveniet quo, voluptatibus eligendi repellendus
                      pariatur dolorum explicabo non vero nobis excepturi tempore ducimus maxime modi. Doloremque,
                      ullam? Optio tempora natus molestiae eveniet quo, voluptatibus eligendi repellendus pariatur
                      dolorum explicabo non vero nobis excepturi tempore ducimus maxime modi.</span>
                  </div>
                </div>
                  ...
                  <div class="col-8  col-md-5 col-lg-4 a3">
                    <div class="d-flex justify-content-between align-items-center gab-3 gap-lg-5 ">
                      <div class="d-flex align-items-center">
                        ...
                        <span class="gray_text_2 ms-1">50$</span>
                      </div>
                      <div class="d-flex align-items-center">
                        <img src="/img/icons/company-svgrepo-com.svg" class="icon-card" width="25" alt="">
                        <a href="campany.html"><span class="gray_text_2 ms-1 campany-name"> Campany Name</span></a>
                      </div>
                    </div>
                  </div>

                  <div class="d-flex justify-content-end">
                    <a href="details-product.html" class="arrow">
